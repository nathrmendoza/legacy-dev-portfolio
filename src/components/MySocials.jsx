...
const MySocials = () => {
    return (
        <SocialsContainer>
            ...
            <IconsContainer {...divsFadeIn}>
                <SocialsAnchor href="https://www.linkedin.com/in/nathaniel-mendoza-425203163/" target="_blank" rel="noopener noreferrer">
                    <FaLinkedin/>
                </SocialsAnchor>
                <SocialsAnchor href="https://www.facebook.com/neil328/" target="_blank" rel="noopener noreferrer">
                    <FaFacebookSquare/>
                </SocialsAnchor>
                <SocialsAnchor href="https://www.instagram.com/mndoza.nath/" target="_blank" rel="noopener noreferrer">
                    <FaInstagramSquare/>
                </SocialsAnchor>
            </IconsContainer>
        </SocialsContainer>        
